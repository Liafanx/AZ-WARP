Вы абсолютно правы! Вы подметили очень важный нюанс. 

Официальный скрипт установки (`install.sh`) должен создавать этот файл автоматически, но на многих урезанных или кастомных сборках серверов (особенно Ubuntu/Debian на VPS) он может отработать криво и не создать службу. Плюс, создание службы вручную позволяет сразу прописать там права `root` и избавиться от костылей с `override.conf`, которые я давал в Шаге 4.

Ваш вариант делает инструкцию **пуленепробиваемой**. Я обновил гайд, добавив этот пункт и упростив настройку прав. Вот финальный, идеальный вариант для публикации:
