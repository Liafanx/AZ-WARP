...
⚠️ **Внимание:** В установке для fake-ip используется подсеть `198.18.0.0/24` во избежание конфликтов с внутренними сетями. Если вы используете эту подсеть где-то ещё, воспользуйтесь ручной установкой.
