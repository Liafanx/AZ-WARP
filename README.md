...
**1. Создаем папку и мастер-файл с доменами(домены гугла добавлены как пример для первого тестирования, если они будут не нуэны или нужно будет добавить другие это можно будет сделать после установки):**
```bash
mkdir -p /root/warper
