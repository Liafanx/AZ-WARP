...
```bash
curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/install.sh | bash
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/web/install-web.sh)
```
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/web/uninstall-web.sh)
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/install-slave.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/uninstaller.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Liafanx/AZ-WARP/dev/uninstall-slave.sh | bash
```
