...
Как починить текущий сервер:
Поскольку вы уже запускали скрипт, у вас лежит сломанный .json. Просто скопируйте обновленный код install.sh, сохраните его на Github, а затем запустите установку заново той же самой командой:
